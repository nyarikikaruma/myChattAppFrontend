<template>
  ...
  <div class="md:w-2/5 lg:w-2/5 w-full rounded-lg bg-blue-500">
        ...
        <div class="overflow-auto w-3/4 bg-green-200">
          <div class="ml-12 m-4 mt-4 rounded-md bg-lime-800 p-2 text-sm text-white">
            ...
            <div class="flex items-center justify-end">
              <p>20:00 </p> 
              <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" version="1.1" class="size-5" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.5">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier"> <polyline points="2.75 8.75,6.25 12.25,13.25 4.75"></polyline> 
              </g>
              </svg>
            </div>
          </div>
          <div class="m-4 mt-4 mr-12 rounded-md bg-blue-800 p-2 text-sm text-white">
            <p>Messa geMessag eMe ssageMessag eMessa geMessag eMessage Message MessageM essa geMe ssa geMe 
              ssageM essageM  ssageM essageMe ssa ge Mess age Mes sageMe ssageMessageMes sageMess age Messa
               geMessag eMe ssageMessag eMessa geMessag eMessage Message MessageM essa geMe ssa geMe ssageM
                essageM  ssageM essageMe ssa ge Mess age Mes sageMe ssageMessageMes sageMess age</p>
                <div class="flex items-center justify-end">
                  <p>20:00 </p>
                </div>
          </div>
           <div class="m-4 mt-4 ml-12  rounded-md bg-lime-800 p-2 text-sm text-white">
            <p>Messa geMessag eMe ssageMessag eMessa geMessag eMessage Message MessageM essa geMe ssa geMe
               ...
               <div class="flex items-center justify-end">
                  <p>20:00 </p>
                  <svg viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-5 text-blue-500">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier"> <path d="M5.03033 11.4697C4.73744 11.1768 4.26256 11.1768 3.96967 11.4697C3.67678 11.7626 3.67678 12.2374 3.96967 
                  12.5303L5.03033 11.4697ZM8.5 16L7.96967 16.5303C8.26256 16.8232 8.73744 16.8232 9.03033 16.5303L8.5 16ZM17.0303 8.53033C17.3232 8.23744 17.3232
                  7.76256 17.0303 7.46967C16.7374 7.17678 16.2626 7.17678 15.9697 7.46967L17.0303 8.53033ZM9.03033 11.4697C8.73744 11.1768 8.26256 11.1768 7.96967
                    11.4697C7.67678 11.7626 7.67678 12.2374 7.96967 12.5303L9.03033 11.4697ZM12.5 16L11.9697 16.5303C12.2626 16.8232 12.7374 16.8232 13.0303 16.5303L12.5
                    16ZM21.0303 8.53033C21.3232 8.23744 21.3232 7.76256 21.0303 7.46967C20.7374 7.17678 20.2626 7.17678 19.9697 7.46967L21.0303 8.53033ZM3.96967 12.5303L7.96967
                      16.5303L9.03033 15.4697L5.03033 11.4697L3.96967 12.5303ZM9.03033 16.5303L17.0303 8.53033L15.9697 7.46967L7.96967 15.4697L9.03033 16.5303ZM7.96967 12.5303L11.9697
                      16.5303L13.0303 15.4697L9.03033 11.4697L7.96967 12.5303ZM13.0303 16.5303L21.0303 8.53033L19.9697 7.46967L11.9697 15.4697L13.0303 16.5303Z" fill="#04aef7"></path> </g>
                  </svg>
                </div>
          </div>
           <div class="m-4 mt-4 mr-12 rounded-md bg-blue-800 p-2 text-sm text-white">
            <p>Messa geMessag eMe ssageMessag eMessa geMessag eMessage Message MessageM essa
               ...
               ge MessageM essa geMe ssa geMe ssageM essageM  ssageM essageMe ssa ge Mess age Mes 
               sageMe ssageMessageMes sageMess age
            </p>
            <div class="flex items-center justify-end">
              <p>20:00 </p>
            </div>
           ...
           <div class="m-4 mt-4 ml-12  rounded-md bg-green-800 p-2 text-sm text-white">
            <p>Messa geMessag eMe ssageMessag eMessa geMessag eMessage Message MessageM essa 
              geMe ssa geMe ssageM essageM  ssageM essageMe ssa ge Mess age Mes sageMe ssageMessageMes
               ...
               essa geMe ssa geMe ssageM essageM  ssageM essageMe ssa ge Mess age Mes sageMe ssageMess
               ageMes sageMess age
            </p>
            <div class="flex items-center justify-end">
              <p>20:00 </p>
